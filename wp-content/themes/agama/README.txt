Agama WordPress Theme, Copyright 2015 - 2022 theme-vision.com
Agama is distributed under the terms of the GNU GPL2

####################### Changelog ######################

= 1.7.2 - 18 April 2022 =
* Fixed left sidebar displaying before the post lists. 
* Fixed minor bugs/issues for WordPress 5.9.3 compatibility.

= 1.7.1 - 11 March 2022 =
* Added Kirki framework to the latest version.
* Fixed minor bugs/issues for WordPress 5.9.1 compatibility.

= 1.7.0 - 19 February 2022 =
* Added option to show/hide top navigation menu in mobile devices.
* Fixed infinite-scroll visibility.
* Fixed blog layout 'list-style' icon size reduced in mobile devices. 
* Fixed reduced space between title and tagline. 
* Fixed some more minor bugs/issues for WordPress 5.9 compatibility.

= 1.6.9 - 17 January 2022 =
* Added option for blog page to hide feature image on posts.
* Fixed view for mobile devices if primary menu is empty/not selected.
* Fixed blog layout 'Small Thumbs Layout' title issue.
* Fixed issue with comments on posts enable/disable option not working. 
* Fixed some more minor bugs/issues for WordPress 5.8.3 compatibility.
